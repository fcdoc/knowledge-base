...
## In Flashduty
---
You can obtain an integrated push address using either of the following two methods; choose one as preferred.

### Use dedicated integrations
...
When you need to route alarm events to different collaboration spaces based on the payload information, this method is preferred.
