...
## In Flashduty
---
You can obtain an integrated push address using the following two methods, choose one as needed.

### Use Exclusive Integration

When you don't need to route alarm events to different collaboration spaces, this method is recommended for its simplicity.
...
When you need to route alarms to different collaboration spaces based on the alarm event's payload information, this method is preferred.
