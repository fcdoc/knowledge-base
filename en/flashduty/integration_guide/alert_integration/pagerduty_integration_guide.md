...
## In Flashduty
---
You can obtain an integrated push address through the following two methods; choose one as needed.
...
When you need to route alarms to different collaboration spaces based on the payload information of the event, this method is preferred.
